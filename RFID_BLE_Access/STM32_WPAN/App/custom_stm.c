...
/* Private typedef -----------------------------------------------------------*/
typedef struct{
  uint16_t  CustomP2PsHdle;                    /**< P2P_Server handle */
  uint16_t  CustomLed_CHdle;                  /**< LED_Char handle */
  uint16_t  CustomSwitch_CHdle;                  /**< Switch_Char handle */
  uint16_t  CustomHrsHdle;                    /**< Heart_Rate handle */
  uint16_t  CustomHrs_MHdle;                  /**< HRS_Meas handle */
  uint16_t  CustomHrs_SlHdle;                  /**< Sensor_Loc handle */
  uint16_t  CustomHrs_CtrlHdle;                  /**< HRS_CTRL_Point handle */
...
#define COPY_LED_CHAR_UUID(uuid_struct)    COPY_UUID_128(uuid_struct,0x00,0x00,0xfe,0x41,0x8e,0x22,0x45,0x41,0x9d,0x4c,0x21,0xed,0xae,0x82,0xed,0x19)
#define COPY_SWITCH_CHAR_UUID(uuid_struct)    COPY_UUID_128(uuid_struct,0x00,0x00,0xfe,0x42,0x8e,0x22,0x45,0x41,0x9d,0x4c,0x21,0xed,0xae,0x82,0xed,0x19)
...
void SVCCTL_InitCustomSvc(void)
{
   ...
   *                                2 for LED_Char +
   *                                2 for Switch_Char +
   *                                1 for Switch_Char configuration descriptor +
   *                              = 6
   *
   ...
   * service_max_attribute_record = 1 for Heart_Rate +
   *                                2 for HRS_Meas +
   *                                2 for Sensor_Loc +
   *                                2 for HRS_CTRL_Point +
   *                                1 for HRS_Meas configuration descriptor +
   *                              = 8
   *
   * This value doesn't take into account number of descriptors manually added
   * In case of descriptors addded, please update the max_attr_record value accordingly in the next SVCCTL_InitService User Section
